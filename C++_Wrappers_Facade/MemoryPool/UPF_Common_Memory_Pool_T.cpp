...
/*********************************************************************************************************************
*       FILE NAME       : UPF_Common_Memory_Pool_T.cpp                                                               *
...
const  char * const COMMON_MEMORY_POOL_TYPE = "Common";
...
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::UPF_Common_Memory_Pool_T(
 ...
 */
template < class Allocator, class Lock, class RecordPolicy >
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::~UPF_Common_Memory_Pool_T( void )
{
...
template < class Allocator, class Lock, class RecordPolicy >
void*
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::allocate( size_t size )
{    
    void * ret = 0;
        ...
        else
        {
            ...
            else
            {
                my_free_small_block = static_cast< Small_Block_Node * > (
                     this->get_memory_space( small_block_size ) );
            }
        }
...
template < class Allocator, class Lock, class RecordPolicy > 
void * 
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::get_memory_space( size_t size )
{
...
template < class Allocator, class Lock, class RecordPolicy > 
inline void * 
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::get_avail_memory_from_free_block_list(
...
template < class Allocator, class Lock, class RecordPolicy > 
void
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::destroy_memory_space( void )
{
    UPF_Guard< Lock > guard( this->m_lock );
 ...
 *  UPF_Common_Memory_Pool::allocate所申请的内存.
 * 
 * @param ptr        [in] 调用UPF_Common_Memory_Pool::allocate所申请的内存
 * @param size       [in] 内存大小
 */
template < class Allocator, class Lock, class RecordPolicy > 
void
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::deallocate( void* ptr, size_t /* size */ )
{
    if ( ptr != 0 )
    {
        UPF_Guard< Lock > guard( this->m_lock );
...
template < class Allocator, class Lock, class RecordPolicy >
inline void
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::reset( void )
{
...
template < class Allocator, class Lock, class RecordPolicy >
void * 
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::reallocate( 
...
template < class Allocator, class Lock, class RecordPolicy >
void
UPF_Common_Memory_Pool_T< Allocator, Lock, RecordPolicy >::
