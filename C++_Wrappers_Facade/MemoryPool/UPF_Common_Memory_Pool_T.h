...
/*********************************************************************************************************************
*       FILE NAME       : UPF_Common_Memory_Pool_T.h                                                                 *
...
*********************************************************************************************************************/
#ifndef UPF_COMMON_MEMORY_POOL_T_H
#define UPF_COMMON_MEMORY_POOL_T_H

#include "UPF_Memory_Pool_Base_T.h"     /* for base class of UPF_Common_Memory_Pool */
...
/** 
 * @class UPF_Common_Memory_Pool_T
 * 
...
class UPF_Common_Memory_Pool_T : public UPF_Memory_Pool_Base< Allocator,
                                                              Lock,
                                                              RecordPolicy >
{
public:
    /// 初始化内部状态.
    UPF_Common_Memory_Pool_T( const char *          memory_pool_name,
                              size_t                allocated_memory_limit = MAX_MEMORY_REQ_SIZE,
                              toplevel_allocator_t  allocator_type = UPF_TOPLEVEL_PERMANENT_ALLOCATOR );

    /// 清除内存池内部申请的所有内存
    ~UPF_Common_Memory_Pool_T( void );
...
private:
    /// 从系统中申请更多的内存.
    void * get_memory_space( size_t size );
...
#include "UPF_Common_Memory_Pool_T.cpp"
#endif /* UPF_TEMPLATES_REQUIRE_SOURCE */

#endif /* UPF_COMMON_MEMORY_POOL_T_H */
